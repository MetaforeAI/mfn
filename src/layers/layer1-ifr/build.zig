...
pub fn build(b: *std.Build) void {
    ...
    // Library for Layer 1 Immediate Flow Registry
    const ifr_lib = b.addStaticLibrary(.{
        .name = "mfn_layer1_ifr",
    ...
    benchmark_exe.linkLibrary(ifr_lib);
    ...
    socket_server_exe.linkLibrary(ifr_lib);
    ...
    socket_client_test_exe.linkLibrary(ifr_lib);
